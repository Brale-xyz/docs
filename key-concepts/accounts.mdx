---
title: "Accounts"
description: "Accounts represent KYB-verified business entities with account_ids used to scope API requests and manage custodial wallets."
---

<p class="intro-subheading">
  Accounts are represented by account\_ids, which are assigned to KYB'd (business) entities. If you
