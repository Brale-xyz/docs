...
:::warning[Legacy / Deprecated] The Financial Institutions resource is superseded by Addresses. New integrations should create offchain accounts (ACH, wire, RTP) as Addresses and pass their `address_id` to Transfers. Plaid endpoints are now under `/plaid/*`. Existing FI integrations continue to work during a deprecation window. :::
...
:::note You can also add Financial Institutions through the Brale Dashboard settings page at https://app.brale.xyz/settings. :::
