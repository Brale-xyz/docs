...
<p class="intro-subheading">
  Get set up quickly, explore key concepts, and ship stablecoin experiences with
  the Brale API.
</p>
...
<Columns cols={3}>
  ...
  <Card
    icon="flask"
    href="/overview/sandbox-and-testnet"
...
<Columns cols={2}>
  <Card
    ...
    href="/documentation/commons-stablecoin-format"
