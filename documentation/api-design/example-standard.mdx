...
description: Canonical conventions used across Brale API docs and examples, including IDs, enum casing, transfer shapes, pagination, and testnet terminology.
---
