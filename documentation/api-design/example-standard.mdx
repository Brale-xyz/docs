...
description: Canonical Brale API conventions used across docs and examples, including IDs, enum casing, Create Transfer shape, pagination, and testnet terminology.
---
