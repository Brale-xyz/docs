...
description: Canonical Brale API conventions used across docs and examples, including IDs, enum casing, transfer shapes, pagination, and testnet terminology.
---
