...
description: Brale API conventions used across docs and examples — IDs, enum casing, SBC placeholder, canonical Create Transfer shape, automations exception, pagination, and testnet terminology.
---
