---
title: "Tokenization"
description: "Issue and operate your own tokens with Brale handling key custody, orchestration, mint and burn execution, and reporting."
---
...
- Read the full implementation guide: [**Tokenization Overview**](/guides/tokenization)
- If you are launching a fiat-backed stablecoin where Brale is issuer, see: [**Stablecoin Issuance**](/guides/stablecoin-issuance)