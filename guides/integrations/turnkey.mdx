...
[Turnkey](https://turnkey.com) is a secure key management infrastructure for provisioning and managing wallets at any scale. Every private key exists inside a [hardware-backed secure enclave](https://docs.turnkey.com/security/secure-enclaves) (TEE), and typical workflows never directly handle private key material.
...
- A [Brale account](https://app.brale.xyz/signup) with KYB started or completed, and an API client created in the Brale Dashboard
...
The examples below cover two common patterns. Turnkey supports additional SDKs. See the [SDK overview](https://docs.turnkey.com/sdks/introduction) for the full list.
...
See [Getting started with the Embedded Wallet Kit](https://docs.turnkey.com/sdks/react/getting-started) for the full provider and authentication setup.
...
See the [TypeScript Server SDK docs](https://docs.turnkey.com/sdks/javascript-server) for authentication and wallet creation.
...
See: [ach\_debit to end user wallet](https://docs.brale.xyz/guides/ach-on-ramp)
...
Turnkey’s policy engine can restrict which contracts and recipients are signable. See [Turnkey policies](https://docs.turnkey.com/concepts/policies/overview) for how to configure signing controls.
...
See: [Stablecoin to Fiat (Offramp)](https://docs.brale.xyz/guides/stablecoin-to-fiat-offramp)
...
- [ach\_debit to end user wallet](https://docs.brale.xyz/guides/ach-on-ramp)
