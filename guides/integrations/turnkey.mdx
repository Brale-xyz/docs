...
description: "Register Turnkey wallets as external Brale addresses to use them as sources or destinations in transfers, with Turnkey handling signing in secure enclaves."
---
