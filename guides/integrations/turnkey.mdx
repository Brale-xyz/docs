...
description: "Pair Turnkey's secure enclave key management with Brale's stablecoin rails by registering Turnkey wallets as external addresses for transfers."
---
