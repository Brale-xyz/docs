...
description: "Register Turnkey-managed wallets as external Brale addresses to use them as sources or destinations for stablecoin transfers and on/off-ramps."
---
