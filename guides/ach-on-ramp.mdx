...
seo:
  title: "Onramp to end-user wallet via ACH debit"
  keywords: "onramp, on-ramp, fund wallet, deposit USD, ACH debit, end user wallet, fiat to stablecoin"
description: "Fund an end-user custodial or self-custody wallet by pulling USD via ACH debit and minting stablecoins."
---

## Introduction

<Info>**Rail:** ACH debit — Brale pulls funds from a Plaid-linked bank account and mints stablecoins to the destination wallet.</Info>

This guide helps your team evaluate and implement ACH debit onramps. It covers what the ACH debit functionalities are, how to get set up, and the key steps to go from initial testing to production. Use it as a reference while you integrate.
