...
description: "Use the Addresses API to list and retrieve your custodial address_id values, which are required for initiating transfers and checking balances."
---
