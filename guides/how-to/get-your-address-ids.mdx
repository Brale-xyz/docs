...
description: "A custodial account_id is an internal (custodial) addresses. You can use custodial accounts to manage balances for specific workflows, or to hold onchain balances for others. To retrieve address_ids for transfers and balances."
---
