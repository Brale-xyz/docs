...
- Submit a [Transfer](/key-concepts/transfers) request with a source transfer_type of `wire`
- Submit a [Transfer](/key-concepts/transfers) request with a source transfer_type of `ach_debit`
