...
<Columns cols={3}>
  ...
  <Card title="Managed accounts" icon="users" href="/guides/managed-accounts">
    Create and operate verified custodial or transactional accounts for your end customers.
  </Card>
  <Card
    title="Payouts"
  ...
  <Card title="Webhooks" icon="webhook" href="/webhooks/overview">
    Receive signed events when transfers, payments, or account verification states change.
  </Card>
</Columns>
