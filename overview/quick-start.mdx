...
Brale automatically creates custodial (internal) wallets for your account—you do not need to create them. You'll see one for EVM blockchains, one for Solana, and one for Stellar by default. See [Supported Blockchains](/coverage/stablecoins-and-blockchains) for the full list.
