---
title: "Introduction"
description: "Overview of the Brale API for issuing, moving, and managing stablecoins across fiat and blockchain rails."
---
...
- [Onramp to custodial wallet](/guides/fiat-to-stablecoin-onramp): deposit USD and mint stablecoins via wire, ACH debit, or automation
- [Onramp to end-user wallet](/guides/ach-on-ramp): fund end-user wallets via ACH debit
- [Offramp to bank account](/guides/stablecoin-to-fiat-offramp): convert stablecoins to USD via wire, ACH, or RTP
- [Swap stablecoins or chains](/guides/stablecoin-to-stablecoin-swap): 1:1 swaps between stablecoins or cross-chain moves
- [Send stablecoin payouts](/guides/stablecoin-payouts): distribute stablecoins to external wallets
- [Custodial accounts](/guides/managed-accounts): hold stablecoins on behalf of your end users
