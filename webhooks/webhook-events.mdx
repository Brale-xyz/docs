...
Emitted when an account requires additional verification documents to proceed.

Use this event to prompt the account holder to submit the requested documents.
...
- Treat `data.id` as the account ID.
- Additional fields may be present as the verification schema evolves.
- Your integration should ignore unknown fields.

## `account.verification.completed`

Emitted when account verification reaches a completed state.
...
- Treat `data.id` as the account ID.
- Treat `data.status` as the completed verification state.
- Additional fields may be present as the verification schema evolves.
- Your integration should ignore unknown fields.
