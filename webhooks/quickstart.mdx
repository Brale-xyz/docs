---
title: "Quickstart: receive your first webhook"
description: "Set up an HTTPS endpoint, get an access token with webhook scopes, and create a subscription to receive your first Brale webhook delivery."
---
