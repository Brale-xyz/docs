...
description: "Verify Brale webhook deliveries by comparing the x-request-signature-sha-256 header against an HMAC-SHA256 of the raw request body using your shared secret."
---
