...
description: "Validate Brale webhook deliveries by recomputing the HMAC-SHA256 signature with your subscription's shared secret over the raw request body."
---
