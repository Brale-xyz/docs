...
description: "Validate Brale webhook deliveries by checking the HMAC-SHA256 signature header against the shared secret returned when you created the subscription."
---
