...
<Note>
If you already know the `address_id`, use [`GET /accounts/{account_id}/addresses/{address_id}`](/api-reference/brale/get-address) to retrieve a single Address directly.
</Note>
