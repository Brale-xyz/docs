...
description: 'Retrieve full details for a single transfer, including source and destination legs, status, and any payment metadata Brale has on file.'
...
```json title="Response (failure excerpt)"
{
  "id": "3D1RcbwVywOGyU2HBSenljm5dhV",
  "status": "failed",
  "failure": {
