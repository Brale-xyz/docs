...
description: 'Retrieve a single webhook subscription by ID, including its destination URL and subscribed event types. The shared secret is not returned.'
openapi: 'GET /accounts/{account_id}/webhooks/{subscription_id}'
---
