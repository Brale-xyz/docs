...
- Archived addresses remain visible in `GET /accounts/{account_id}/addresses` and [`GET /accounts/{account_id}/addresses/{address_id}`](/api-reference/brale/get-address) responses with `status: "archived"`.
