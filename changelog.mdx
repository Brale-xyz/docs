...
<Update label="2026-07-13" description="Week of July 6" tags={["Update"]}>
  No user-facing product changes shipped this week. See [transfer types](/coverage/transfer-types) for the current list of supported networks.
</Update>
