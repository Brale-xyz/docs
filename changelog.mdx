...
<Update label="2026-09-07" description="Week of September 1" tags={["New"]}>
  ## International transactional accounts

  Business and individual transactional accounts are now available in 131 approved countries outside the United States, in addition to existing U.S. coverage. Non-US individual accounts are created through the standard API flow: set `individual.country` and send a matching identity document type. Custodial accounts remain U.S.-only. See [account availability](/coverage/account-availability#international-transactional-availability) for the full country list and [individual accounts](/guides/individual-accounts) for the creation flow.
</Update>
